...
public class TemplateMessageVo {
	   ...
	   */
	  @Builder.Default
	  private LinkedHashMap<String,KeywordData> data = new LinkedHashMap<>();
	  
//	  @Builder.Default
//	  private List<QuitMpTemplateData> data = new ArrayList<>();
//
//	  public TemplateMessageVo addData(QuitMpTemplateData datum) {
//	    if (this.data == null) {
