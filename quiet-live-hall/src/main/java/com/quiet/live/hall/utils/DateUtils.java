...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static String DATE_FORMAT_DATEONLY_ZN = "yyyy年MM月dd日"; // 年/月/日
	public static String DATE_FORMAT_DATETIME = "yyyy-MM-dd HH:mm:ss"; // 年/月/日
	public static String DATE_FORMAT_DATETIME_TIME = "yyyyMMddHHmmss"; // 年/月/日
	public static String DATE_FORMAT_DATETIME_TIME_NEW = "yyyyMMddHHmmss"; // 年/月/日
...
//	public static final SimpleDateFormat formatTimestamp = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	...
	public static String getLongDateStrYYYYMMDDD() {
		return new SimpleDateFormat("yyyy/MM/dd HH:mm:ss").format(new Date());
	}
	 ...
	 * @return
	 */
    public static Date addMon(Date date,int mon) {  
	 ...
	 * 获取几天内日期 return 2014-5-4、2014-5-3
	 */
	public static String getQmDays(int countDay) {
		List<String> listDate = new ArrayList<String>();
		for (int i = 0; i < countDay; i++) {
			listDate.add(DateUtils.getReqDateyyyyMMdd(DateUtils.getDate(-i)));
		}
	 ...
	 * 获取几天内日期 return 2014-5-4、2014-5-3
	 */
	public static String getHmDays(int countDay) {
		List<String> listDate = new ArrayList<String>();
		for (int i = 0; i < countDay; i++) {
			listDate.add(DateUtils.getReqDateyyyyMMdd(DateUtils.getDate(i)));
		}
...
//		System.out.println(getHmDays(3));
...
//		System.out.println(getFirstDayOfMonth(new Date()));
	...
	public static long getMinuteCompan(LocalDateTime inDate, LocalDateTime nowDate) {
